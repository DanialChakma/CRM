...
$installation_cost = mysql_real_escape_string(trim($params['installation_cost']));
...
$installation_cost    = empty($installation_cost) ? 0.0: $installation_cost;
$total_receive = $collected_amount+$delivery_cost+$installation_cost;
