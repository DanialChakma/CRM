...
$total_receive = round(($collected_amount_u+$delivery_cost_u),4);
...
if( $collection_status === "yes" ){
    ...
    $update_qry = "UPDATE monthly_bill_call_list SET cash_receive='$collected_amount_u',delivery_cost='$delivery_cost_u',total_receive='$total_receive',receipt_number='$receipt_number_u', `collection_status`='confirm' WHERE `id`='$mb_id';";
