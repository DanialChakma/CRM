...
function apiErrorHandling($e, $APIindex = "", $arrayInput = array(), $apiUrl = '')
{
    $content = "**************************************" . PHP_EOL;
    $content = $content . "Message: APIindex '$APIindex' with input" . print_r($arrayInput, TRUE) . " has faced this error on " . date("l jS \of F Y h:i:s A") . " with response '$e' from url '$apiUrl'" . PHP_EOL;

    $myFile = 'log/apiError/errorLog.txt';
